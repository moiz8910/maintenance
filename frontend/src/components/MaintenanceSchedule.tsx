    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">
            Pending Work Order Pipeline • Real-time Monitoring
          </p>
        </div>
                      ...
                      >
                        <div className="flex items-center gap-1 justify-between">
                          <div className="flex items-center gap-1 min-w-0">
                            ...
                            {item.status === 'Closed' && (
                              <span className="ml-1 px-1 py-0.5 bg-slate-200 text-slate-600 rounded text-[7px] font-black uppercase">
                                Closed
                              </span>
                            )}
                          </div>
      ...
      <div className="flex items-center gap-6 px-4 py-3 bg-white rounded-2xl border border-slate-100 shadow-sm w-fit">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-bold text-emerald-700">In Progress (Approved)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-md bg-rose-50 border border-rose-200"></div>
          <span className="text-[9px] font-bold text-rose-700">Missing Permit (Critical)</span>
        </div>
        <div className="flex items-center gap-2 ml-2">
          <AlertTriangle size={12} className="text-rose-500" />
          <span className="text-[9px] font-bold text-slate-600">Resource Conflict / Overlap</span>
        </div>
        <div className="flex items-center gap-2">
